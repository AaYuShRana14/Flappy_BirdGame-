...
GAME_SPRITES = {}
GAME_SOUNDS = {}
PLAYER='/FLAPPY/sprites/bluebird-midflap.png'
BACKGROUND='/FLAPPY/sprites/background-night.png'
PIPE='/FLAPPY/sprites/pipe-green.png'
...
if __name__ == "__main__":
    ...
    GAME_SPRITES['numbers'] = ( 
        ...
        pygame.image.load('/FLAPPY/sprites/1.png').convert_alpha(), #alpha render img fast
    ...
    # Game sounds
    GAME_SOUNDS['die']=pygame.mixer.Sound('/FLAPPY/audio/assets_audio_die.wav')
    GAME_SOUNDS['hit']=pygame.mixer.Sound('/FLAPPY/audio/assets_audio_hit.wav')
    GAME_SOUNDS['point']=pygame.mixer.Sound('/FLAPPY/audio/assets_audio_point.wav')
    GAME_SOUNDS['swoosh']=pygame.mixer.Sound('/FLAPPY/audio/assets_audio_swoosh.wav')
    GAME_SOUNDS['wing']=pygame.mixer.Sound('/FLAPPY/audio/assets_audio_wing.wav')
